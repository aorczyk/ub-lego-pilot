...
basic.forever(function() {
    ...
    if (outX != x || outY != y) {
        ...
        // soroban.showNumber(x, Align.C2, false)
        // soroban.showNumber(y, Align.C5, false)
    }
